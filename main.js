...
function render() {
  ...
  ReactDOM.render (
    e(ReactRedux.Provider, {store: store}, [
      e('div', {className: 'carousel-wrapper'}, [
        e('div', {className: 'carousel'}, [
          e('p', {className: 'header'}, 'gallery'),
          e('div', {className: 'carousel-items'}, [
            e('img', {className: 'carousel__photo initial', src: store.getState().images[store.getState().currentIndex]}, null),

            e('div', {className: 'carousel-title'}, [
          ...
          e('div', {className: 'bottoms-flipping'}, [
            e('button', {className: 'left-circle', onClick: function(event) {
              store.dispatch({type: 'FIRST-IMG-INDICATOR'})
            }}, [
              e('i', {className: 'fas fa-circle'}, null)
            ]),
            e('button', {className: 'middle-circle', onClick: function(event) {
              store.dispatch({type: 'SECOND-IMG-INDICATOR'})
            }}, [
              e('i', {className: 'fas fa-circle'}, null)
            ]),
            e('button', {className: 'right-circle', onClick: function(event) {
